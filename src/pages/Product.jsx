...
const Product = () => {
    ...
    /* Control length text description  */
    const lengthText = (text, numCaracter) => {

        if (text.length > numCaracter) {
            return (text)
        } else if (numCaracter >= text.length) {
            for (let i = text.length; i < numCaracter; i++) {
                text = text + " " + "\u00a0" // Agregar espacios
            }
            return (text)
        }
    }
                ...
                <Row>

                    {
                        productsSuggest.map((suggest) => (
                            ...
                            <Col xs={12} sm={4} md={3} key={suggest.id}>
                                <Card style={{ width: '100%', padding: 10, marginTop: 20 }} >
                                    ...
                                    <Card.Body>
                                        ...
                                        <Card.Text>
                                            <p>{lengthText(suggest.title, 20)}</p>
                                        </Card.Text>
                                    </Card.Body>
                                    <Card.Body>
                                        <Row>
